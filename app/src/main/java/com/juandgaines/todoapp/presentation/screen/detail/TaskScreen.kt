...
import com.juandgaines.todoapp.presentation.screen.detail.providers.TaskScreenStatePreviewProvider
        ...
        Column(
            ...
            Row( 
                ...
                Checkbox(
                    ...
                    onCheckedChange = {
                        onAction(ActionTask.ChangeTaskDone( isTaskDone =  it))
                        //ActionTask.ChangeTaskDone( isTaskDone =  it)
                    },
                            ...
                            Column {
                                Category.entries.forEach { category ->
                                    Text(
                                        ...
                                        padding(8.dp)
                                            .clickable {
                                                onAction(ActionTask.ChangeTaskCategory(category))
                                                isExpanded = false
                                            }
                                    )
                                }
            ...
            BasicTextField(
                ...
                decorator = { innerTextField ->
                        ...
                        if(state.taskName.text.toString().isEmpty() && !isNameFocus){
                            Text(
            ...
            BasicTextField(
                ...
                decorator = { innerTextField  ->
                    ...
                    if(state.taskDescription.text.isEmpty() && !isDescriptionFocus){
                        Text(
